...
# proti Boosted klasickému je zde přidán Adam

class Network():

    def __init__(self , sizes, biases = None, weights = None , gamma=None,gamma_output = 6,
                 weight_initilizer = 'new', cost = None, output_func = 'sigmoid', momentum1 = 0.9, momentum2 = 0.99,epsilon = 1e-8):
    ...
    def update_mini_batch(self, mini_batch, eta, lmbda, n):
        ...
        self.n_weights = [(self.momentum2*n + (1-self.momentum2)*(w**2)) for n,w in zip(self.n_weights,nabla_w)]
