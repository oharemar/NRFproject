...
for dataset in datasets:
    ...
    for model,eta in zip(model_names,learn_rates):
        ...
        with open('RESULTS_PUBLIC_DATASETS_betterSoftmax_ave/{}/{}_mean.txt'.format(model,dataset), 'w') as file:
            file.write(json.dumps(final_results_vals))
        with open('RESULTS_PUBLIC_DATASETS_betterSoftmax_ave/{}/{}_std.txt'.format(model, dataset), 'w') as file:
            file.write(json.dumps(final_results_stds))
