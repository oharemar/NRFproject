...
if __name__ == '__main__':
    ...
    fig.savefig('NRF_regularization_acc_bigBeta.png')
    ...
    fig.savefig('NRF_regularization_F1_bigBeta.png')
    ...
    fig.savefig('NRF_DW_regularization_acc_bigBeta.png')
    ...
    fig.savefig('NRF_DW_regularization_F1_bigBeta.png')
    ...
    fig.savefig('NRF_EL_DW_regularization_acc_bigBeta.png')
    ...
    fig.savefig('NRF_EL_DW_regularization_F1_bigBeta.png')
    ...
    fig.savefig('NRF_EL_DW_identity_regularization_acc_bigBeta.png')
    ...
    fig.savefig('NRF_EL_DW_identity_regularization_F1_bigBeta.png')