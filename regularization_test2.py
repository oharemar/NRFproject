...
if __name__ == '__main__':
    ...
    learn_rates_nrfdw = list(np.linspace(0, 100, num=15))
    learn_rates_nrf = list(np.linspace(0, 100, num=15))
    learn_rates_nrfel = list(np.linspace(0, 100, num=15))
    learn_rates_nrfeldw = list(np.linspace(0, 100, num=15))
    ...
    fig.savefig('NRF_regularization_acc_rough.png')
    ...
    fig.savefig('NRF_regularization_F1_rough.png')
    ...
    fig.savefig('NRF_DW_regularization_acc_rough.png')
    ...
    fig.savefig('NRF_DW_regularization_F1_rough.png')
    ...
    fig.savefig('NRF_EL_DW_regularization_acc_rough.png')
    ...
    fig.savefig('NRF_EL_DW_regularization_F1_rough.png')
