...
if __name__ == '__main__':
    ...
    datasets = ['bank_marketing','valley','wine','messidor','cars','vehicle_silhouette','diabetes'] # pak přidáme USPS a drive diagnosis
        ...
        for model,eta in zip(model_names,learn_rates):
            ...
            for _ in range(2):
                ...
                for train_index, test_index in kf.split(df):
                    ...
                    predictions = nrf.predict_averaging(X_test)
            ...
            with open('RESULTS_PUBLIC_DATASETS_FINAL_avg/{}/{}_mean.txt'.format(model,dataset), 'w') as file:
                file.write(json.dumps(final_results_vals))
            with open('RESULTS_PUBLIC_DATASETS_FINAL_avg/{}/{}_std.txt'.format(model, dataset), 'w') as file:
