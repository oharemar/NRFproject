...
if __name__ == '__main__':
    ...
    fig.savefig('NRF_beta2_acc_with_RF.png')
    ...
    fig.savefig('NRF_DW_beta2_acc_with_RF.png')
    ...
    fig.savefig('NRF_EL_DW_beta2_acc_with_RF.png')
    ...
    fig.savefig('NRF_EL_DW_identity_beta2_acc.png')
    ...
    fig.savefig('NRF_EL_DW_identity_beta2_acc_with_RF.png')
    ...
    fig.savefig('NRF_EL_DW_identity_beta2_F1.png')
