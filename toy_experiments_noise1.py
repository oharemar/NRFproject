...
if __name__ == '__main__':
    ...
    for sample in samples:
        ...
        for noise in noises:
            ...
            X, y = dt.make_circles(sample, noise=noise, random_state=3)

            #X_5, y_5 = datasets.make_moons(sample, noise=noise, random_state=2)
        ...
        i = 1
        plt.tight_layout()
        fig.savefig('noise1{}_samples{}'.format(dataset, sample))
        dataset += 1
