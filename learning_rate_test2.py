...
if __name__ == '__main__':
    ...
    fig.savefig('NRF_learning_rate_ROUGH_acc.png')
    ...
    fig.savefig('NRF_learning_rate_ROUGH_F1.png')
    ...
    fig.savefig('NRF_DW_learning_rate_ROUGH_acc.png')
    ...
    fig.savefig('NRF_DW_learning_rate_ROUGH_F1.png')
    ...
    fig.savefig('NRF_EL_DW_learning_rate_ROUGH_acc.png')
    ...
    fig.savefig('NRF_EL_DW_learning_rate_ROUGH_F1.png')
    ...
    fig.savefig('NRF_EL_DW_identity_learning_rate_ROUGH_acc.png')
    ...
    fig.savefig('NRF_EL_DW_identity_learning_rate_ROUGH_F1.png')
