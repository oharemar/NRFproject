...
if __name__ == '__main__':
    ...
    learn_rates_nrfdw = list(np.linspace(0.0002, 0.1, num=15))
    learn_rates_nrf = list(np.linspace(0.0002, 0.1, num=15))
    learn_rates_nrfel = list(np.linspace(0.001, 0.2, num=15))
    learn_rates_nrfeldw = list(np.linspace(0.001, 0.2, num=15))
    learn_rates_nrfeldw_ultra = list(np.linspace(0.001, 0.2, num=15))
    ...
    fig.savefig('NRF_learning_rate_acc_ROUGH.png')
    ...
    fig.savefig('NRF_learning_rate_F1_ROUGH.png')
    ...
    fig.savefig('NRF_DW_learning_rate_acc_ROUGH.png')
    ...
    fig.savefig('NRF_DW_learning_rate_F1_ROUGH.png')
    ...
    for j in range(accuracy_nrfeldw_temp.shape[0]):
        ax.errorbar(learn_rates_nrfeldw, accuracy_nrfeldw_temp[j, :], yerr=None, marker='o', color='lightgray',
                    alpha=0.5,zorder=-32)
    ...
    fig.savefig('NRF_EL_DW_learning_rate_acc_ROUGH.png')
    ...
    fig.savefig('NRF_EL_DW_learning_rate_F1_ROUGH.png')
    ...
    for j in range(accuracy_nrfeldw_ultra_temp.shape[0]):
        ax.errorbar(learn_rates_nrfeldw_ultra, accuracy_nrfeldw_ultra_temp[j, :], yerr=None, marker='o',
                    color='lightgray', alpha=0.5,zorder=-32)
    ax.errorbar(learn_rates_nrfeldw_ultra, accuracy_nrfeldw_ultra, yerr=accuracy_nrfeldw_ultra_std, ecolor='darkorange',
                marker='o')
    plt.title('NRF_EL_DW_identity')
    plt.ylim([np.amin(accuracy_nrfeldw_ultra_temp) - 0.05, np.amax(accuracy_nrfeldw_ultra_temp) + 0.05])
    fig.savefig('NRF_EL_DW_identity_learning_rate_acc_ROUGH.png')
    ...
    for j in range(f_nrfeldw_ultra_temp.shape[0]):
        ax.errorbar(learn_rates_nrfeldw_ultra, f_nrfeldw_ultra_temp[j, :], yerr=None, marker='o', color='lightgray',
                    alpha=0.5,zorder=-32)
    ...
    fig.savefig('NRF_EL_DW_identity_learning_rate_F1_ROUGH.png')
