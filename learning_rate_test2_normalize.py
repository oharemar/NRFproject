...
if __name__ == '__main__':
    ...
    fig.savefig('NRF_learning_rate_acc_ROUGH_norm.png')
    ...
    fig.savefig('NRF_learning_rate_F1_ROUGH_norm.png')
    ...
    fig.savefig('NRF_DW_learning_rate_acc_ROUGH_norm.png')
    ...
    fig.savefig('NRF_DW_learning_rate_F1_ROUGH_norm.png')
    ...
    fig.savefig('NRF_EL_DW_learning_rate_acc_ROUGH_norm.png')
    ...
    fig.savefig('NRF_EL_DW_learning_rate_F1_ROUGH_norm.png')
    ...
    fig.savefig('NRF_EL_DW_identity_learning_rate_acc_ROUGH_norm.png')
    ...
    fig.savefig('NRF_EL_DW_identity_learning_rate_F1_ROUGH_norm.png')